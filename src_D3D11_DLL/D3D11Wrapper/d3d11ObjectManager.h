...
public:
	std::ofstream Event;
	ID3D11DeviceContext* pContext2;
	ID3D11Device* pDevice2;
...
public:
	...
	// Present Notify
	//
	void Notify_Present(IDXGISwapChain4* p_swap_chain, UINT sync_interval, UINT present_flags, const DXGI_PRESENT_PARAMETERS* p_present_params, ID3D11DeviceContext* pContext);
