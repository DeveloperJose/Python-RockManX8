...
{
	DEBUG_LOGLINE(m_pGLOM->Event, LOG("D3D11CustomContext1"));
	CommonInitialise();
	m_devContext = devCon;
	*ret = &m_devContext;
...
{
	DEBUG_LOGLINE(m_pGLOM->Event, LOG("D3D11CustomContext2"));
	CommonInitialise();
	m_devContext = devCon;
	m_pGLOM = Parent;
	//m_eCurrentState = ECaptureState::Await;
...
{
	DEBUG_LOGLINE(m_pGLOM->Event, LOG("D3D11CustomContext3"));
	CommonInitialise();
	m_devContext = dev;
	m_pFalseDevice = cdev;
